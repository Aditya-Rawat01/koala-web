...
import type { Monitor } from "../pages/Dashboard";
  ...
  useEffect(() => {
    if (isEdit && monitor) {
      try {
        ...
        setExpectedStatus(
          monitor.expected_status ? monitor.expected_status.toString() : "",
        );
  ...
  const handleSave = async () => {
    ...
    if (isEdit && monitor) {
      try {
        ...
        toast.error(
          <div className="flex flex-col">
            <span className="font-semibold">Failed to edit Monitor</span>
      ...
      try {
        ...
        toast.error(
          <div className="flex flex-col">
            <span className="font-semibold">Failed to create Monitor</span>
            <span className="text-xs opacity-70">See console for details</span>
          </div>,
        );
      }
